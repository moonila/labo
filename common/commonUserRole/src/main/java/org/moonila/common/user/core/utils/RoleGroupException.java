...
public class RoleGroupException extends Exception {
	 ...
	 * @param message
	 */
	public RoleGroupException(final String message) {
		super(message);
	}
	 ...
	 * @param cause
	 */
	public RoleGroupException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause
	 */
	public RoleGroupException(final Throwable cause) {
		super(cause);
	}
}
