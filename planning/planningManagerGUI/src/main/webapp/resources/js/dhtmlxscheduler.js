scheduler._props = {}, scheduler.createUnitsView = function(e, t, r, s, a, i) {
        "object" == typeof e && (r = e.list, t = e.property, s = e.size || 0, a = e.step || 1, i = e.skip_incorrect, e = e.name), scheduler._props[e] = {
            map_to: t,
            options: r,
            step: a,
            position: 0
        }, s > scheduler._props[e].options.length && (scheduler._props[e]._original_size = s, s = 0), scheduler._props[e].size = s, scheduler._props[e].skip_incorrect = i || !1, scheduler.date[e + "_start"] = scheduler.date.day_start, scheduler.templates[e + "_date"] = function(e) {
            ...
            var a = scheduler._get_unit_index(r, t),
                i = s[a];
            return scheduler.templates[e + "_scale_text"](i.key, i.label, i)
        }, scheduler.date["add_" + e] = function(e, t) {
            return scheduler.date.add(e, t, "day")
        }, scheduler.date["get_" + e + "_end"] = function(t) {
            return scheduler.date.add(t, scheduler._props[e].size || scheduler._props[e].options.length, "day")
            ...
            if (t) {
                e = this._week_indexes_from_pos(e), this._drag_event || (this._drag_event = {}), this._drag_id && this._drag_mode && (this._drag_event._dhx_changed = !0);
                var r = Math.min(e.x + t.position, t.options.length - 1);
                e.section = (t.options[r] || {}).key, e.x = 0;
        ...
        var t = scheduler._props[this._mode];
        t && (t.position = Math.min(Math.max(0, t.position + e), t.options.length - t.size), this.update_view())
    },
    function() {
        var e = function(e) {
        ...
        var s = function(e, t) {
                if (e && "undefined" == typeof e.order[t[e.map_to]]) {
                    ...
                    return t[e.map_to] = e.options[Math.min(a + e.position, e.options.length - 1)].key, !0
                }
            },
            a = scheduler._reset_scale,
            i = scheduler.is_visible_events;
        scheduler.is_visible_events = function(e) {
            ...
            if (e) {
                ...
                if (e.size && e.size < e.options.length) {
                    var i = this._els.dhx_cal_header[0],
                        n = document.createElement("DIV");
                    e.position && (n.className = "dhx_cal_prev_button", n.style.cssText = "left:1px;top:2px;position:absolute;", n.innerHTML = "&nbsp;", i.firstChild.appendChild(n), n.onclick = function() {
                        scheduler.scrollUnit(-1 * e.step)
                    }), e.position + e.size < e.options.length && (n = document.createElement("DIV"), n.className = "dhx_cal_next_button", n.style.cssText = "left:auto; right:0px;top:2px;position:absolute;", n.innerHTML = "&nbsp;", i.lastChild.appendChild(n), n.onclick = function() {
        ...
        var n = scheduler._get_event_sday;
        scheduler._get_event_sday = function(e) {
            var t = scheduler._props[this._mode];
            return t ? (s(t, e), t.order[e[t.map_to]] - t.position) : n.call(this, e)
        };
...
window.dhtmlXScheduler = window.scheduler = {
        ...
        for (var s = 0; s < e.length; s++)
            for (var n = 0; n < e[s].childNodes.length; n++) _isKHTML ? e[s].childNodes[n].tagName && e[s].childNodes[n].tagName.toUpperCase() == t && (i[i.length] = e[s].childNodes[n]) : e[s].childNodes[n].tagName == t && (i[i.length] = e[s].childNodes[n]);
        return i
    ...
    function() {
        ...
        function s(e, t, i) {
            var s = i ? i : e || "",
                n = "dhtmlx_" + s.toLowerCase().replace(/ /g, "_") + "_button";
        ...
        function r(t, i, n) {
            ...
            if (t.buttons)
                for (var l = 0; l < t.buttons.length; l++) a += s(t.buttons[l], l);
        ...
        function a(e, s, n) {
            ...
            var d = Math.abs(Math.floor(((window.innerWidth || document.documentElement.offsetWidth) - a.offsetWidth) / 2)),
                o = Math.abs(Math.floor(((window.innerHeight || document.documentElement.offsetHeight) - a.offsetHeight) / 2));
        ...
        afterUpdate: function(e, t, i, s, n) {
            if (n.getXMLTopNode("data"), n.xmlDoc.responseXML) {
                for (var r = n.doXPath("//data/action"), a = 0; a < r.length; a++) {
                    var d = r[a],
                        o = d.getAttribute("type"),
                        l = d.getAttribute("sid"),
                        h = d.getAttribute("tid");
            ...
            i = i.replace("editing=true&", ""), this.getUpdates(i, function() {
                ...
                if (i.length) {
                    ...
                    for (var s = 0; s < i.length; s++) {
                        var n = i[s].getAttribute("status"),
                            r = i[s].getAttribute("id"),
                            a = i[s].getAttribute("parent");
                        switch (n) {
                            case "inserted":
        ...
        }), this.attachEvent("onXLE", function(e, t, i, s) {}), this._init_point_connector && this._init_point_connector()
            ...
            for (var e = this.xmlLoader.doXPath("./coll_options", arguments[0]), t = 0; t < e.length; t++) {
                ...
                for (var r = this.xmlLoader.doXPath("./item", e[t]), a = 0; a < r.length; a++) {
                    ...
                    if (n) {
                        ...
                        n.addOption ? n.addOption([
                            [d, o]
                        ]) : n.put(d, o), s[s.length] = o
                    } else s[s.length] = d
                }
        ...
        if (this._drag_mode) {
            ...
            if (!this._drag_pos || t.force_redraw || this._drag_pos.x != t.x || this._drag_pos.y != t.y) {
                ...
                if (scheduler.config.limit_drag_out && (+u < +scheduler._min_date || +s > +scheduler._max_date)) {
                    var f = s - u; + u < +scheduler._min_date ? (u = new Date(scheduler._min_date), s = new Date(+u + f)) : (s = new Date(scheduler._max_date), u = new Date(+s - f));
                    var c = new Date(s - 1)
                }
        ...
        var i = new Date(scheduler._min_date),
            ...
            n = this.date.date_part(scheduler._currentDate()),
            r = parseInt(e.style.width, 10),
            a = new Date(this._min_date),
        ...
        if (this.templates[this._mode + "_date"]) {
            ...
            var n, r, a = this._get_timeunit_start(),
        ...
        if (r)
            for (var a = new Date(e), d = 0; t > d; d++) r(a) && (this._ignores_detected += 1, this._ignores[d] = !0, n && t++), a = scheduler.date.add(a, s, i)
        ...
        var n = scheduler.date.add(t, 1, "month"),
            r = new Date(i),
        ...
        var s = scheduler.date.add(t, 1, "month"),
            n = scheduler._currentDate();
        this.date.date_part(n), this.date.date_part(i);
        var r = Math.ceil(Math.round((s.valueOf() - i.valueOf()) / 864e5) / 7),
            a = Math.floor(e.clientHeight / r) - this.xy.month_head_height;
        ...
        for (var i = this.config.lightbox.sections, s = 0; s < i.length; s++)
            if (i[s].map_to == e)
                for (var n = i[s].options, r = 0; r < n.length; r++)
                    if (n[r].key == t) return n[r].label;
        return ""
        ...
        if (i._start_correction || i._end_correction) {
            ...
            var d = 60 * (i.last_hour - i.first_hour),
                o = Math.ceil((t / 6e4 - a) / d);
            t += o * (1440 - d) * 60 * 1e3
        }
        var l, h = new Date(1 * e + t * r),
        ...
        getISOWeek: function(e) {
            ...
            var s = i.getFullYear(),
                n = Math.round((i.getTime() - new Date(s, 0, 1).getTime()) / 864e5),
                r = 1 + Math.floor(n / 7);
            return r
        },
    ...
    function() {
        ...
        if (t) {
            ...
            var s = (e.end_date.valueOf() - e.start_date.valueOf()) / 36e5,
                n = 24 - (this.config.last_hour - this.config.first_hour);
            return s > n
        }
        return !1
        ...
        for (var t = this._rendered_location, i = this._lame_clone(e), s = e._sday; s < e._eday; s++) {
            ...
            var n = scheduler.date,
                r = scheduler._min_date;
            r = n.add(r, i._sweek, "week"), r = n.add(r, i._sday, "day");
            var a = scheduler.getEvents(r, n.add(r, 1, "day")).length,
        ...
        if (e = this._table_view ? this._pre_render_events_table(e, t) : this._pre_render_events_line(e, t), this._table_view)
            if (t) this._colsS.heights = s;
                ...
                if (a.rows) {
                    ...
                    var g = (a.parentNode.childNodes, (n[0] + 1) * i + 1),
                        v = g,
                        m = g + "px";
        ...
        for (var i, s = [], n = [
                ...
                [],
                []
            ], r = this._colsS.heights, a = this._cols.length, d = {}, o = 0; o < e.length; o++) {
            var l = e[o],
                h = l.id;
            d[h] || (d[h] = {
                first_chunk: !0,
        ...
        var i = 60 * e.start_date.getHours() + e.start_date.getMinutes(),
            ...
            n = this._y_from_date(e.start_date),
            r = Math.max(t, (s - i) * this.config.hour_size_px / 60);
        return {
            top: n,
            height: r
        }
        ...
        if (!(e._sday < 0)) {
            ...
            if (s) {
                var n = this._calc_event_y(e, scheduler.xy.min_event_height),
                    r = n.top,
                    a = n.height,
                    d = e._count || 1,
                    o = e._sorder || 0,
        ...
        var u = e.color ? "background:" + e.color + ";" : "",
            ...
            g = '<div event_id="' + h + '" class="' + _ + '" style="position:absolute; top:' + i + "px; left:" + t + "px; width:" + (s - 4) + "px; height:" + n + "px;" + (r || "") + '"></div>';
        l.innerHTML = g;
        ...
        var a = n * s,
            d = this._colsS.heights[e._sweek] + (this._colsS.height ? this.xy.month_scale_height + 2 : 2) + a;
        return {
            x: t,
            x2: i,
            y: d
        ...
        if (r) {
            ...
            f && (u += " " + f);
            var g = e.color ? "background:" + e.color + ";" : "",
                v = e.textColor ? "color:" + e.textColor + ";" : "",
                m = ["position:absolute", "top:" + s + "px", "left:" + n + "px", "width:" + (r - n - 15) + "px", v, g, e._text_style || ""].join(";"),
        ...
        parse_param: function(e, t) {
            ...
            if (-1 != i) {
                var s = e.substr(0, i).toLowerCase(),
                    n = e.substr(i + 1).replace(/\\\,/g, ",").replace(/[\r\n]+$/, "");
        ...
        parse_date: function(e, t, i) {
            ...
            var n = s[0].substr(0, 4),
                r = parseInt(s[0].substr(4, 2), 10) - 1,
                a = s[0].substr(6, 2);
        ...
        for (var n = this.config.lightbox.sections, r = 0; r < n.length; r++) {
            var a = n[r],
                d = document.getElementById(a.id).nextSibling,
                o = this.form_blocks[a.type],
                l = void 0 !== i[a.map_to] ? i[a.map_to] : a.default_value;
        ...
        for (var t = this.config.lightbox.sections, i = 0; i < t.length; i++) {
            ...
            var n = this.form_blocks[t[i].type],
                r = n.get_value.call(this, s, e, t[i]);
        ...
        var a, d, o, l, h, _, c = -1 != navigator.userAgent.indexOf("Android") && -1 != navigator.userAgent.indexOf("WebKit"),
            u = 0;
